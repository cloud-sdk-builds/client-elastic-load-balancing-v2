...
[`@aws-sdk/client-elastic-load-balancing-v2`](https://www.npmjs.com/package/@aws-sdk/client-elastic-load-balancing-v2/v/3.712.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-elastic-load-balancing-v2@3.712.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-D6PT0Awkw+FXSGq7Nt3+QSmHQANEy8hKXhiHFBOrEqNLabnKnb5n128CByYNb20X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-elastic-load-balancing-v2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-elastic-load-balancing-v2@3.712.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-elastic-load-balancing-v2@3.712.0/index.min.mjs": "sha384-D6PT0Awkw+FXSGq7Nt3+QSmHQANEy8hKXhiHFBOrEqNLabnKnb5n128CByYNb20X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-elastic-load-balancing-v2/blob/refs/tags/3.712.0/LICENSE
```
